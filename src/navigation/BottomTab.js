...
const BottomTab = () => {
    ...
    return (
      ...
      <Tab.Screen
        name="BurnandEarn"
        component={BurnandEarn}
        options={{
          tabBarLabel: '',
          tabBarIcon: ({focused}) =>
            focused ? (
              <Entypo name="new-message" size={25} color={AppTheme.iconcolor} />
            ) : (
              <Entypo name="new-message" size={25} color={AppTheme.iconcolor1} />
            ),
        }}
      />
...
<Tab.Screen
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({focused}) =>
            focused ? (
              <Icon name="users" size={25} color={AppTheme.iconcolor} />
            ) : (
              <Icon name="users" size={25} color={AppTheme.iconcolor1} />
            ),
        }}
      />
